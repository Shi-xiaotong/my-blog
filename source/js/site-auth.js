...
function ensureModal(){
  ...
  modal.innerHTML='<div class="slm-box">'
    ...
    +'<input type="email" id="slmEmailInput" placeholder="邮箱地址" onkeydown="if(event.key===\'Enter\')siteLogin()">'
    +'<input type="password" id="slmPasswordInput" placeholder="密码" onkeydown="if(event.key===\'Enter\')siteLogin()">'
    ...
    +'<div class="slm-email-form">'
    +'<input type="email" id="slmRegEmailInput" placeholder="邮箱地址" onkeydown="if(event.key===\'Enter\')siteRegSendCode()">'
    ...
    +'<input type="text" id="slmRegCodeInput" placeholder="输入6位验证码" maxlength="6" onkeydown="if(event.key===\'Enter\')document.getElementById(\'slmRegPasswordInput\').focus()">'
    +'</div>'
    +'<input type="password" id="slmRegPasswordInput" placeholder="设置密码（至少6位）" onkeydown="if(event.key===\'Enter\')siteRegVerify()" style="margin-top:8px">'
    ...
    +'<div class="slm-email-form">'
    +'<input type="email" id="slmResetEmailInput" placeholder="邮箱地址" onkeydown="if(event.key===\'Enter\')siteResetSendCode()">'
    ...
    +'<input type="text" id="slmResetCodeInput" placeholder="输入6位验证码" maxlength="6" onkeydown="if(event.key===\'Enter\')document.getElementById(\'slmResetPasswordInput\').focus()">'
    +'</div>'
    +'<input type="password" id="slmResetPasswordInput" placeholder="新密码（至少6位）" onkeydown="if(event.key===\'Enter\')siteResetVerify()" style="margin-top:8px">'
